...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            {{ Form::open(['url' => 'roles/' . $role->id, 'method' => 'PUT', 'class' => 'validate form-horizontal', "novalidate" => 'novalidate']) }}
            {{ Form::hidden('id', $role->id) }}
                <div class="form-group">
                    {{ Form::label('display_name', 'Полное название роли', ['class' => 'control-label col-sm-2']) }}
                    <div class="col-sm-10">
                        {{  Form::text('display_name', $role->display_name, ['class' => 'form-control', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Полное название роли'])}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{  Form::text('name', $role->name, ['class' => 'form-control', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Название роли (ключ)'])}}
                    </div>
                </div>
                <div class="form-group-separator __web-inspector-hide-shortcut__"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{  Form::textarea('description', $role->description, ['class' => 'form-control', "placeholder" => 'Описание роли'])}}
                    </div>
                </div>
                <div class="form-group">
