...
@endsection
@section('content')
    {!! Form::open(['url' => 'users/' . $user->id, 'method' => 'PUT', 'class' => 'validate', "novalidate" => 'novalidate']) !!}
        ...
        <div class="panel-body">
            ...
            <div class="member-form-add-header">
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8">
                        ...
                        <div class="user-name">
                            <a href="#">{{ $user->name }}</a>
                            <span>{{ $user->Role()->display_name or ''}}</span>
                        </div>
            ...
            <div class="member-form-inputs">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            {{  Form::text('email', $user->email, ['class' => 'form-control', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Email'])}}
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            {{  Form::text('phone', $user->phone, ['class' => 'form-control', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Телефон', "data-mask" => "phone"]) }}
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            {{  Form::text('birthdate', $user->birthdate, ['class' => 'form-control datepicker', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Дата рождения', 'data-date-format' => 'yyyy-mm-dd'])}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        {{ Form::select('role', $roles, $user->Role()->id, ['class' => 'select2']) }}
                    </div>
                </div>

                <div class="row form-group">
                    <div class="col-sm-3">
                        {{ Form::label('active', 'Активен', ['class' => 'control-label']) }}
                    </div>
                    <div class="col-sm-9">
                        {{ Form::checkbox('active', 1, $user->active, ['class' => 'iswitch iswitch-secondary']) }}
                    </div>
                </div>
