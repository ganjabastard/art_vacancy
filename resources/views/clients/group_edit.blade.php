...
@section('pagetitle')
    <div class="page-title">
        <div class="title-env">
            <h1 class="title">Редактирование группы полей клиента</h1>
        ...
        <div class="breadcrumb-env">
            <ol class="breadcrumb bc-1" >
                ...
                <li class="active">
                    <strong>Редактирование прав доступа</strong>
                </li>
            </ol>
        </div>
    </div>
...
<div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-title">
                Редактирование группы полей клиента
            </div>
        </div>

        <div class="panel-body">
            {{ Form::open(['url' => 'client_fields/groups/' . $group->id, 'method' => 'PUT', 'class' => 'validate form-horizontal', "novalidate" => 'novalidate']) }}
                <div class="form-group">
                    {{ Form::label('name', 'Название группы', ['class' => 'control-label col-sm-2']) }}
                    <div class="col-sm-10">
                        {{  Form::text('name', Helper::getLang($group->translate_id), ['class' => 'form-control', 'data-validate' => 'required', 'data-message-required' => 'Поле обязательно для заполнения', "placeholder" => 'Название группы'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('active', 'Активность', ['class' => 'control-label col-sm-2']) }}
                    <div class="col-sm-10">
                        {{ Form::checkbox('active', 1, $group->active, ['class' => 'iswitch iswitch-secondary']) }}
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
